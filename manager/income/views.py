...
class IncomeListView(APIView):
    ...
    def get(self, request):
        try:
            ...
            return Response(
                data={"message": "Не удалось получить доход"}, status=status.HTTP_401_UNAUTHORIZED
            )
    ...
    def post(self, request):
        try:
            ...
            return Response(
                data={"message": "Невозможно добавить новый доход"},
...
class IncomeDetailView(APIView):
    ...
    def get(self, request, pk):
        ...
        if request.user == income.user:
            ...
            return Response(data={"message": "Не разрешено"},
